...

{
   ...
   /**
    * @brief  LOCK FUNCTION - ALL LED's ON 
    * @author Indrani V
    * 
    */
   void Lock(void)
	  ...
	  /**
	   * @brief UNLOCK FUNCTION - All LED's OFF 
   ...
   /**
    * @brief ALARM ACTIVATION/DECTIVATION - ALL LED's ON CLOCKWISE
    * @author Malakalapalli Nagendra
    * 
    */
   ...
   /**
    * @brief APPROACH FUNCTION - ALL LED's ON ANTI-CLOCKWISE
